...
<body class="text-white min-h-screen flex flex-col">
    ...
    <main class="flex-1 max-w-2xl mx-auto w-full px-4 py-8 relative z-0">
        <div class="post-card border-2 border-amber-700 p-6 bg-gradient-to-b from-amber-950 to-transparent">
            <h1 class="text-xl font-bold mb-6 text-amber-100" style="letter-spacing: 2px;">[ NEW POST ]</h1>

            @if ($errors->any())
                <div class="bg-red-950 border-2 border-red-700 text-red-200 px-4 py-3 mb-6">
                    <ul>
